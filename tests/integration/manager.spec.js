...
// criar variavel de ambiente para rodar o teste no banco de teste
...
describe("MANAGERS", () => {
  ...
  it("não é possivel cadastrar um gerente com cpf já existente", async () => {
